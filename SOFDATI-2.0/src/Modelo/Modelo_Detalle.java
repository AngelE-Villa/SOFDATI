...
public class Modelo_Detalle extends Detalle_Servicio {
    ...
    public boolean EliminarProducto(String pro, String cod) {
        String sql;
        ...
        public boolean EliminarDetalle(String cod) {
        String sql;
        sql = "DELETE FROM detalle_servicio WHERE cod_servicio_d='"+cod+"';";
        if (con.noQuery(sql) == null) {
            return true;
        } else {
            return false;
